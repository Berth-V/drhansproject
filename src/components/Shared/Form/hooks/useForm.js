...
export default function useForm() {
    ...
    function validateField(name, value) {
        ...
        switch (name) {
            ...
            case 'email':
                ...
                break;
            case 'phone':
                if (value && !regex.phone.test(value)) return 'Please enter a valid phone number.';
                break;
            default:
                break;
        }
    ...
    async function onSubmit(e) {
        ...
        if (!validateAll()) {
            setStatus({ sending: false, ok: false, error: 'Please correct the highlighted fields.' });
            return;
        }
    ...
    return { formData, consent, status, errors, setConsent, handleChange, onSubmit };
}
