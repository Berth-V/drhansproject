...
import { trackCall, trackTikTok, trackInstagram, trackFacebook } from '../../../../analytics/events';
  ...
  return (
    <section className="frontpage">
      <div className="frontpage__textBox">
        ...
        <div className="frontpage__ctaWrapper">
          <div className="frontpage__ctaGroup">
            <NavLink className="frontpage__primaryBtn" to="/contact">
              {t('frontpage.cta')}
            </NavLink>
            <a className="frontpage__phoneCta" href="tel:+526645410955" onClick={trackCall}>
              <svg
          ...
          <div className="frontpage__social">
            ...
            <a href="https://www.instagram.com/drhansruiz/" target="_blank" rel="noopener noreferrer" className="frontpage__socialLink" aria-label="Instagram" onClick={trackInstagram}>
              <RiInstagramFill />
            </a>
            <a href="https://www.facebook.com/DrHansRuiz" target="_blank" rel="noopener noreferrer" className="frontpage__socialLink" aria-label="Facebook" onClick={trackFacebook}>
              <FaFacebookSquare />
            </a>
          </div>
        </div>
