    ...
    <section className="privacy">
      <div className="privacy__container">
        ...
        <p className="privacy__text">
          Dr. Hans Ruiz, located in Tijuana, Baja California, Mexico, is
        ...
        <p className="privacy__text">
          ...
          phone number when you fill out our contact or appointment forms.
        </p>

        <h2 className="privacy__subtitle">2. How we use your information</h2>
        <ul className="privacy__list">
          <li className="privacy__list-item">
            To schedule medical appointments or consultations.
          </li>
          <li className="privacy__list-item">
            To communicate regarding medical services and procedures.
          </li>
          <li className="privacy__list-item">
        ...
        <p className="privacy__text">
          ...
          ensure your data is protected against unauthorized access, disclosure,
          or misuse.
        </p>
        ...
        <p className="privacy__text">
          By using this website, you understand that your information may be
          transferred to and processed in Mexico where our clinic is located.
        </p>

        <h2 className="privacy__subtitle">7. Updates</h2>
        <p className="privacy__text">
          We may update this Privacy Policy periodically. Any changes will be
          reflected on this page with the updated date below.
        </p>
