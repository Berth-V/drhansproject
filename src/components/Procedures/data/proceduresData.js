    ...
    injuries: [
      {
        ...
        description: "Break in one or more of the malleoli (medial, lateral, or posterior).",
        treatment: {
      ...
      },
      {
        ...
        description: "Damage to ligaments surrounding the ankle due to twisting or accident.",
        treatment: {
      ...
      },
      {
        ...
        description: "Damage to the articular cartilage, caused by trauma or wear.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Protrusion or rupture of a cervical intervertebral disc that may press on nerve roots.",
        treatment: {
          conservative: "Rest, physical therapy, analgesics, and nerve blocks.",
          severe: "Surgery such as discectomy or arthrodesis for persistent or severe cases."
        }
      },
      {
        id: "neuropathy-radiculopathy",
        name: "Neuropathy or Radiculopathy",
        description: "Compression or inflammation of cervical nerves causing radiating arm pain.",
        treatment: {
          initial: "Anti-inflammatories, physical therapy and postural control.",
          chronic: "Epidural injections or decompressive surgery in chronic cases."
        }
      },
      {
        ...
        treatment: {
          ...
          severe: "Surgery if there is significant medullary or radicular compression."
        }
      },
      {
        id: "disc-prosthesis",
        name: "Disc Prosthesis Placement",
        description: "Replacement of a cervical disc with a mobile prosthesis to preserve movement.",
        treatment: {
          indication: "Surgery indicated when there is severe disc damage without fusion."
        }
      },
      {
        id: "vertebral-fusion",
        name: "Vertebral Fusion",
        description: "Surgical union of two or more vertebrae to stabilize the spine.",
        treatment: {
          indication: "Indicated in cases of cervical instability, multiple herniations or fractures."
        }
      },
      {
        ...
        treatment: {
          advantages: "Faster recovery, less postoperative pain. Indicated for herniations and mild to moderate stenosis."
        }
      }
    ]
  },
    ...
    injuries: [
      {
        ...
        description: "Common break of the bone between the sternum and shoulder.",
        treatment: {
          nonDisplaced: "Immobilization with sling for non-displaced fractures.",
      ...
      },
      {
        ...
        description: "Break in the outer third of the clavicle, near the shoulder.",
        treatment: {
  ...
  elbow: {
    ...
    injuries: [
      ...
      },
      {
        id: "epicondylitis",
        name: "Epicondylitis",
        description: "Inflammation of elbow tendons (tennis or golfer's elbow).",
        treatment: {
      ...
      },
      {
        ...
        description: "Fracture of the posterior end of the ulna, part of the elbow.",
        treatment: {
      ...
      },
      {
        ...
        description: "Minimally invasive surgery to treat internal elbow injuries.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Break of the long shaft of the femur, usually from severe trauma (accidents, falls).",
        treatment: {
          standard: "Almost always surgical: fixation with intramedullary nail.",
          children: "In children, sometimes traction + cast if the fracture is not displaced."
        }
      },
      {
        id: "femoral-neck-fracture",
        name: "Femoral Neck Fracture",
        description: "Fracture between the femoral head and the shaft of the bone, common in elderly people.",
        treatment: {
          young: "Fixation with screws in young patients.",
          elderly: "Partial replacement (hemiarthroplasty) or total (hip prosthesis) in older adults."
        }
      },
      {
        id: "distal-femur-fracture",
        name: "Distal Femur Fracture",
        description: "Break near the knee, affects joint and may be intra-articular.",
        treatment: {
      ...
      },
      {
        ...
        description: "Fracture around an already placed hip or knee prosthesis.",
        treatment: {
          evaluation: "Careful evaluation: if the prosthesis is stable, it can be fixed with plates or nails.",
    ...
    injuries: [
      {
        ...
        treatment: {
          nonDisplaced: "Immobilization with boot or cast for non-displaced fractures.",
      ...
      },
      {
        ...
        description: "Lateral deviation of the big toe, generates bump at the base of the toe.",
        treatment: {
      ...
      },
      {
        ...
        description: "Deformity of the lesser toes, which bend downward or upward.",
        treatment: {
      ...
      },
      {
        ...
        treatment: {
          standard: "Rest, physical therapy, anti-inflammatories, orthopedic insoles.",
      ...
      },
      {
        ...
        name: "Calcaneus Fracture",
        description: "Fracture of the bone that forms the heel, generally from falling from height.",
        treatment: {
      ...
      },
      {
        id: "flat-foot",
        name: "Flat Foot",
        description: "Collapse of the arch of the foot, congenital or acquired (adult).",
        treatment: {
  ...
  forearm: {
    ...
    injuries: [
      ...
      },
      {
        id: "ulna-fracture",
        name: "Ulna Fracture",
        description: "Injury to the medial bone of the forearm, often associated with direct trauma.",
        treatment: {
      ...
      },
      {
        ...
        treatment: {
          ...
          severe: "Surgery if there is associated fracture or recurrent dislocations."
        }
      },
      {
        ...
        treatment: {
          ...
          children: "In children, can sometimes be treated with cast if no displacement."
        }
      },
      {
    ...
    injuries: [
      {
        ...
        treatment: {
          conservative: "Night wrist braces, anti-inflammatories, physical therapy.",
      ...
      },
      {
        ...
        description: "Inflammation that causes the finger to get stuck when bending.",
        treatment: {
    ...
    injuries: [
      {
        ...
        name: "Femoral Neck Fracture",
        description: "Break in the upper part of the femur, just below the femoral head. Frequent in older adults.",
        treatment: {
      ...
      },
      {
        ...
        description: "Progressive degeneration of the articular cartilage, causes pain and limited movement.",
        treatment: {
      ...
      },
      {
        ...
        description: "Damage to the ring of cartilage that surrounds the hip socket.",
        treatment: {
      ...
      },
      {
        ...
        description: "Non-traumatic or mild trauma fracture in people with low bone density.",
        treatment: {
          standard: "Surgery (prosthesis or fixation).",
          followUp: "Subsequent osteoporosis treatment with medications and diet."
        }
      },
      {
        id: "hip-prosthesis",
    ...
    injuries: [
      {
        ...
        description: "Injury near the shoulder, common in falls in older people.",
        treatment: {
          nonDisplaced: "Sling and immobilization for non-displaced fractures.",
          displaced: "Surgery with plates or nails, or prosthesis if very fragmented."
        }
      },
      {
      ...
      },
      {
        ...
        description: "Break near the elbow, more common in children and older adults.",
        treatment: {
          standard: "Surgery with plates and screws.",
      ...
      },
      {
        ...
        description: "May occur along with humerus fractures; causes weakness in wrist and finger extension.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Complete displacement of the tibia relative to the femur. Serious injury that can damage ligaments and blood vessels.",
        treatment: {
      ...
      },
      {
        ...
        description: "Damage to the cartilages that act as shock absorbers inside the knee.",
        treatment: {
      ...
      },
      {
        ...
        description: "Break of the anterior bone of the knee (patella), generally from direct trauma.",
        treatment: {
          nonDisplaced: "Immobilization with splint or cast for non-displaced fractures.",
      ...
      },
      {
        ...
        description: "Pain in the anterior part of the knee due to abnormal rubbing between the patella and femur.",
        treatment: {
      ...
      },
      {
        ...
        description: "Replacement of joint surfaces with metal and plastic components.",
        treatment: {
          indications: "Advanced osteoarthritis, severe deformities, chronic disabling pain.",
      ...
      },
      {
        ...
        description: "Minimally invasive surgery to repair intra-articular tissues.",
        treatment: {
          advantages: "Less postoperative pain, faster recovery, minimal scars."
        }
      }
    ]
  },
    ...
    injuries: [
      {
        ...
        description: "Break of a vertebral body, common from falls or accidents.",
        treatment: {
          stable: "Rest, lumbar corset for stable fractures.",
          unstable: "Surgery (fixation with screws) for unstable or with neurological damage."
        }
      },
      {
        id: "sciatica",
        name: "Sciatica",
        description: "Pain that radiates down the leg caused by compression of the sciatic nerve.",
        treatment: {
      ...
      },
      {
        ...
        description: "Protrusion of the intervertebral disc that compresses nerve roots.",
        treatment: {
      ...
      },
      {
        ...
        treatment: {
          standard: "Anti-inflammatories, physical therapy, biological therapy in severe cases."
        }
      },
      {
        id: "spinal-stenosis",
      ...
      },
      {
        ...
        description: "Medical emergency due to compression of the lumbar nerve roots.",
        treatment: {
      ...
      },
      {
        id: "spinal-fusion",
        name: "Spinal Fusion",
        description: "Surgery to stabilize vertebrae that have lost alignment or mobility.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Damage to one or more of the tendons that make up the rotator cuff (supraspinatus, infraspinatus, subscapularis and teres minor).",
        treatment: {
          conservative: "Physical therapy, anti-inflammatories, rest.",
          complete: "Surgical: arthroscopic or open repair if there is complete rupture."
        }
      },
      {
        id: "shoulder-wear",
        name: "Shoulder Joint Wear (Glenohumeral Osteoarthritis)",
        description: "Progressive degeneration of the cartilage that lines the shoulder joint.",
        treatment: {
      ...
      },
      {
        ...
        name: "Proximal Humerus Fracture",
        description: "Break in the upper part of the humerus, common in older people after falls.",
        treatment: {
          conservative: "Conservative with sling, rehabilitation.",
          displaced: "Surgery: plates, screws or prosthesis in displaced fractures."
        }
      },
      {
        id: "shoulder-dislocation",
        name: "Shoulder Dislocation",
        description: "Exit of the humeral head from the glenoid cavity (anterior dislocation is the most common).",
        treatment: {
          immediate: "Urgent reduction.",
          rehabilitation: "Physical therapy for recovery.",
          recurrent: "Surgery if there are recurrent dislocations (Bankart repair, remplissage)."
        }
      },
      {
        id: "clavicle-fracture-shoulder",
        name: "Clavicle Fracture",
        description: "Bone break between the sternum and shoulder, frequent due to trauma.",
        treatment: {
          conservative: "Conservative with figure-eight bandage.",
          severe: "Surgery with plate if there is displacement or severe comminution."
        }
      },
      {
        id: "acromion-fracture",
        name: "Acromion Fracture",
        description: "Injury to the bone that forms part of the scapula and roof of the shoulder.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Break of the vertebral bodies in the middle region of the spine.",
        treatment: {
      ...
      },
      {
        ...
        description: "Vertebral displacement generally associated with high-energy trauma.",
        treatment: {
      ...
      },
      {
        ...
        name: "Compression Fracture",
        description: "Partial collapse of the vertebral body, common in osteoporosis.",
        treatment: {
      ...
      },
      {
        ...
        description: "Break of the central bone of the thorax, generally from vehicular accidents.",
        treatment: {
      ...
      },
      {
        ...
        name: "Cauda Equina Syndrome",
        description: "Although more common in the lumbar region, it can appear in high thoracolumbar injuries.",
        treatment: {
    ...
    injuries: [
      {
        ...
        description: "Break in the middle part of the shin bone, usually caused by direct trauma or accidents.",
        treatment: {
      ...
      },
      {
        ...
        treatment: {
          ...
          displaced: "Surgery in articular fractures or with displacement (plates and screws)."
        }
      },
      {
    ...
    injuries: [
      {
        ...
        name: "Distal Radius Fracture",
        description: "The most common wrist fracture, caused by falls on an outstretched hand.",
        treatment: {
      ...
      },
      {
        ...
        description: "Abnormal displacement of the carpal bones with respect to the radius or ulna.",
        treatment: {
          standard: "Closed or open reduction depending on the degree of injury.",
      ...
      },
      {
        ...
        description: "Break of the scaphoid bone, one of the carpal bones, difficult to diagnose initially.",
        treatment: {
          standard: "Prolonged immobilization (due to its slow healing process).",
          surgical: "Surgery if there is displacement or non-union (bone graft, cannulated screw)."
        }
      },
      {
      ...
      },
      {
        ...
        name: "Carpal Tunnel Syndrome",
        description: "Compression of the median nerve in the carpal tunnel, causes numbness and pain in the hand.",
        treatment: {
